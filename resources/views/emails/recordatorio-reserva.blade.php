...
<head>
    ...
    <title>Falta una hora para tu reserva</title>
</head>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e5e7eb;">
                    <tr>
                        <td style="background:linear-gradient(135deg,#0f172a,#2563eb);padding:28px 32px;color:#fff;">
                            ...
                            <h1 style="margin:10px 0 0;font-size:28px;line-height:1.2;">¡Tu cita es en una hora!</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:32px;">
                            <p style="margin:0 0 24px;font-size:16px;line-height:1.6;">
                                Hola <strong>{{ $reserva->cliente->name }}</strong>, te recordamos que en breve comenzará tu sesión:
                            </p>
                            ...
                            <p style="margin:0 0 24px;font-size:15px;line-height:1.6;color:#374151;">
                                Podés revisar todos los detalles desde tu panel de reservas.
                            </p>
